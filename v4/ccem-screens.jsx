...
function TopicPill({ tema }) {
  ...
  return <span style={{...PILL,background:color+'18',color,border:`1px solid ${color}28`,fontSize:9.5,padding:'3px 9px'}}>{tema}</span>;
}
        ...
        <div style={{flex:1,minWidth:0}}>
          ...
          {s.navegavel&&(
            <div style={{display:'flex',alignItems:'center',justifyContent:'flex-end',marginTop:6,gap:5}}>
              {isMarked&&<span style={{fontFamily:'JetBrains Mono,monospace',fontSize:8.5,color:C.azulSoft}}>marcada</span>}
    ...
    return (
      <div style={{marginTop:6,background:C.verde+'12',borderRadius:7,padding:'6px 9px',display:'flex',alignItems:'center',gap:7}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          ...
          <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:8.5,color:C.cinza,marginTop:1}}>{(slides.size/1024).toFixed(0)} KB</div>
        </div>
        <a href={slides.dataUrl} download={slides.name}
  ...
  return (
    <>
      ...
      <button onClick={()=>slInputRef.current&&slInputRef.current.click()}
        style={{marginTop:6,display:'inline-flex',alignItems:'center',gap:5,fontSize:10.5,color:C.cinza,background:'none',border:`1px dashed ${C.linha}`,borderRadius:7,padding:'4px 10px',cursor:'pointer',fontFamily:'DM Sans,sans-serif'}}>
        📎 Enviar slides
      </button>
    </>
  );
      ...
      <div style={{flex:1,overflowY:'auto',padding:'14px 14px 28px'}}>
        ...
        <div style={{background:'#fff',borderRadius:14,padding:'14px',border:`1px solid ${C.linhaSoft}`,marginBottom:10,boxShadow:'0 2px 10px rgba(29,62,138,.05)'}}>
          <div style={{display:'flex',gap:6,flexWrap:'wrap',alignItems:'center',cursor:isPast?'pointer':'default'}}
            ...
            {isPast&&<span style={{marginLeft:'auto',fontFamily:'JetBrains Mono,monospace',fontSize:8,color:C.cinza,opacity:.6}}>
          ...
          {!ctxOpen&&isPast&&(
            <div style={{display:'flex',gap:8,alignItems:'center',fontFamily:'JetBrains Mono,monospace',fontSize:10,color:C.cinza,marginTop:6}}>
              <span style={{color:C.azulSoft,fontWeight:700}}>{s.inicio}–{s.fim}</span>
              {s.moderador&&<span style={{opacity:.6,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>mod. {s.moderador}</span>}
            </div>
          )}
        </div>
            ...
            {s.falas.map((f,i)=>{
              ...
              return (
                <div key={i} style={{display:'flex',gap:10,padding:'8px 0',borderBottom:i<s.falas.length-1?`1px solid ${C.linhaSoft}`:'none'}}>
                  <div style={{width:22,height:22,borderRadius:7,background:bc+'1a',color:bc,display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'JetBrains Mono,monospace',fontSize:10,fontWeight:700,flexShrink:0,marginTop:1}}>{f.n==='·'?'·':f.n}</div>
                  <div style={{flex:1,minWidth:0}}>
                    ...
                    {bio&&<div style={{fontSize:10.5,color:C.cinza,marginTop:1}}>{bio.role}</div>}
    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%',overflow:'hidden'}}>
      ...
      {hasFilter&&(
        <div style={{display:'flex',gap:5,padding:'5px 12px',background:'#f0f4fc',borderBottom:`1px solid ${C.linhaSoft}`,flexShrink:0,overflowX:'auto',scrollbarWidth:'none',alignItems:'center'}}>
          {filtroTipo&&<span style={{...chipSt(true,C.azul),fontSize:10.5,padding:'3px 10px'}}>{filtroTipo==='simposio'?'Simpósio':filtroTipo==='mini'?'Mini':'Satélite'}</span>}
          {soMarcados&&<span style={{...chipSt(true,C.ouro),fontSize:10.5,padding:'3px 10px'}}>★ Marcados</span>}
        ...
        <div style={{position:'fixed',inset:0,zIndex:200,display:'flex',flexDirection:'column',justifyContent:'flex-end',background:'rgba(0,0,0,.38)'}}
          ...
          <div style={{background:'#fff',borderRadius:'18px 18px 0 0',padding:'20px 18px 36px',maxWidth:440,width:'100%',margin:'0 auto',boxShadow:'0 -4px 32px rgba(10,18,50,.18)'}}
            ...
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:18}}>
              <span style={{fontFamily:'JetBrains Mono,monospace',fontSize:10,textTransform:'uppercase',letterSpacing:'0.1em',color:C.cinza,fontWeight:600}}>Filtrar sessões</span>
            ...
            <div style={{marginBottom:16}}>
              <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:9,color:C.cinza,textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:9}}>Tipo de sessão</div>
        ...
        <div style={{flex:1,overflowY:'auto',padding:'14px 14px 28px'}}>
          ...
          {w.audio&&(
            <div style={{display:'flex',alignItems:'center',gap:10,padding:'10px 12px',background:'#fff',borderRadius:10,border:`1px solid ${C.linhaSoft}`,marginBottom:12}}>
              ...
              <div>
                <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:8.5,color:C.cinza,textTransform:'uppercase',letterSpacing:'0.06em'}}>Áudio do autor</div>
      ...
      <div style={{flex:1,overflowY:'auto',padding:'8px 12px 20px'}}>
        ...
        {filtered.map(w=>(
          <div key={w.id} onClick={()=>setSelected(w.id)} style={{background:'#fff',borderRadius:10,padding:'11px 12px',marginBottom:7,border:`1px solid ${C.linhaSoft}`,cursor:'pointer',transition:'transform .12s'}}
            ...
            <div style={{display:'flex',gap:8,fontFamily:'JetBrains Mono,monospace',fontSize:9,color:C.cinza,alignItems:'center'}}>
...
function InfoScreen() {
  ...
  const CR = ({icon,lbl,val,href})=><div style={{display:'flex',alignItems:'center',gap:11,padding:'9px 0',borderBottom:`1px solid ${C.linhaSoft}`}}>
    ...
    <div><div style={{fontFamily:'JetBrains Mono,monospace',fontSize:8.5,color:C.cinza,textTransform:'uppercase',letterSpacing:'0.07em',marginBottom:2}}>{lbl}</div>
    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%',overflow:'hidden'}}>
      <div style={{flex:1,overflowY:'auto',paddingBottom:24}}>
        ...
        <div style={{background:C.azul,color:'#fff',padding:'20px 16px 18px'}}>
          <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:9,letterSpacing:'0.12em',textTransform:'uppercase',opacity:.6,marginBottom:4}}>SBEM-SC · Sociedade Brasileira de Endocrinologia e Metabologia</div>
          ...
          <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:10,background:'rgba(255,255,255,.12)',padding:'7px 10px',borderRadius:6,letterSpacing:'0.02em',lineHeight:1.7}}>
        ...
        <IC>
          ...
          <div style={{display:'flex',gap:8,fontSize:12.5,color:C.cinza,padding:'6px 0'}}>
            <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:9,color:C.cinza,textTransform:'uppercase',letterSpacing:'0.08em',width:72,flexShrink:0,lineHeight:1.6}}>Cert.</div>
        ...
        <IC>
          ...
          <div style={{display:'flex',alignItems:'center',gap:11,padding:'9px 0'}}>
            ...
            <div>
              <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:8.5,color:C.cinza,textTransform:'uppercase',letterSpacing:'0.07em',marginBottom:2}}>Site oficial</div>
        ...
        <IC>
          ...
          <div style={{display:'flex',alignItems:'center',gap:8,padding:'7px 0',borderTop:`1px solid ${C.linhaSoft}`,marginBottom:10}}>
            <span style={{fontFamily:'JetBrains Mono,monospace',fontSize:9,color:C.cinza,textTransform:'uppercase',letterSpacing:'0.06em',flexShrink:0}}>ID local</span>
            <code style={{fontFamily:'JetBrains Mono,monospace',fontSize:10.5,color:C.tinta,background:'#f0f4fc',padding:'2px 7px',borderRadius:5,flex:1,overflow:'hidden',textOverflow:'ellipsis'}}>{window.CCEM_USER_ID||'—'}</code>
          </div>
        ...
        {/* Rodapé */}
        <div style={{textAlign:'center',padding:'18px 16px 4px',fontFamily:'JetBrains Mono,monospace',fontSize:9.5,color:C.cinza,lineHeight:1.9}}>
          <div>Meu CCEM 2026 · v4.0</div>
          <div style={{opacity:.5}}>Ferramenta experimental · uso restrito a inscritos</div>
          <div style={{marginTop:6}}>
            <a href="https://www.ccem2026.com.br" target="_blank" rel="noopener" style={{color:C.azul,textDecoration:'none',fontSize:10}}>ccem2026.com.br · site oficial do congresso ↗</a>
          </div>
        </div>
      </div>
    </div>
      ...
      {tabs.map(t=>{
        ...
        return (
          <button key={t.id} onClick={()=>go('#/'+t.id)}
            ...
            {t.icon}
            <span style={{fontFamily:'DM Sans,sans-serif',fontSize:9.5,fontWeight:on?600:400}}>{t.lbl}</span>
          </button>
        );
      })}
    </nav>
  ...
  return (
    <div style={{width:220,background:'#fff',borderRight:`1px solid ${C.linha}`,display:'flex',flexDirection:'column',flexShrink:0,height:'100%',overflow:'hidden'}}>
      ...
      <div style={{padding:'12px 16px',borderTop:`1px solid ${C.linhaSoft}`}}>
        <div style={{fontFamily:'JetBrains Mono,monospace',fontSize:8,color:C.cinza,opacity:.5,lineHeight:1.7}}>v4.0 · Meu CCEM<br/>acesso restrito a inscritos</div>
      </div>
    </div>
  );
}
